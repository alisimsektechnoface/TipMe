...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20231010133815_UpdateTipTable")]
    partial class UpdateTipTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9f476800-d090-47e5-8a33-3d900f21a0f5"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 10, 16, 38, 14, 960, DateTimeKind.Local).AddTicks(2068),
                            IsDeleted = false,
                            Name = "Admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("62e492c9-3f16-4f97-88c1-97d297e6e3c6"),
                            AuthenticatorType = 0,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 10, 16, 38, 14, 961, DateTimeKind.Local).AddTicks(2783),
                            CultureType = 0,
                            Email = "admin@admin.com",
                            FirstName = "Admin",
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 8, 190, 10, 165, 82, 134, 43, 78, 108, 58, 79, 57, 89, 223, 57, 10, 85, 187, 3, 127, 87, 60, 34, 144, 82, 70, 232, 32, 92, 61, 255, 214, 126, 69, 125, 100, 50, 199, 231, 160, 183, 131, 210, 161, 148, 143, 75, 32, 228, 104, 58, 172, 161, 255, 187, 59, 56, 241, 223, 128, 195, 240, 56, 61 },
                            PasswordSalt = new byte[] { 41, 169, 187, 54, 100, 211, 208, 106, 205, 100, 237, 2, 107, 36, 252, 191, 63, 2, 170, 104, 35, 75, 107, 153, 160, 160, 117, 176, 172, 70, 0, 5, 123, 86, 151, 176, 166, 151, 65, 27, 193, 212, 233, 112, 169, 185, 108, 120, 198, 194, 94, 128, 42, 232, 182, 238, 246, 172, 84, 104, 5, 127, 23, 38, 252, 169, 238, 192, 150, 119, 103, 247, 67, 215, 41, 19, 82, 233, 240, 54, 240, 198, 231, 161, 197, 144, 166, 32, 42, 74, 37, 92, 163, 173, 76, 210, 9, 213, 244, 26, 29, 165, 215, 2, 20, 153, 240, 115, 184, 227, 24, 180, 10, 115, 67, 76, 72, 212, 88, 106, 72, 196, 82, 14, 174, 215, 106, 238 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("735e3192-d68c-413c-b682-650545cb00ee"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 10, 16, 38, 14, 961, DateTimeKind.Local).AddTicks(8161),
                            IsDeleted = false,
                            OperationClaimId = new Guid("9f476800-d090-47e5-8a33-3d900f21a0f5"),
                            Status = 1,
                            UserId = new Guid("62e492c9-3f16-4f97-88c1-97d297e6e3c6")
                        });
                });
