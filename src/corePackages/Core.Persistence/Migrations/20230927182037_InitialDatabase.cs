        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTipped = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Waiters_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Waiters_WaiterId",
                        column: x => x.WaiterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceOptions_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceOptions_Options_OptionId",
                        column: x => x.OptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceOptions_InvoiceId",
                table: "InvoiceOptions",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceOptions_OptionId",
                table: "InvoiceOptions",
                column: "OptionId");
