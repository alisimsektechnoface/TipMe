...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20231017151852_AddPhotoColumnStore")]
    partial class AddPhotoColumnStore
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2fa5d3f5-1770-45b6-af11-d8e251cc4f77"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 17, 18, 18, 52, 31, DateTimeKind.Local).AddTicks(5734),
                            IsDeleted = false,
                            Name = "Admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6d64ba23-da92-4364-93ae-7b129d56b771"),
                            AuthenticatorType = 0,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 17, 18, 18, 52, 32, DateTimeKind.Local).AddTicks(7674),
                            CultureType = 0,
                            Email = "admin@admin.com",
                            FirstName = "Admin",
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 108, 19, 110, 152, 29, 20, 149, 160, 150, 97, 101, 151, 45, 143, 246, 108, 123, 40, 151, 120, 214, 145, 216, 146, 51, 137, 83, 88, 248, 190, 2, 102, 130, 155, 44, 248, 69, 236, 22, 171, 69, 180, 252, 158, 0, 243, 102, 252, 101, 239, 138, 232, 54, 83, 28, 186, 160, 22, 131, 210, 198, 241, 107, 151 },
                            PasswordSalt = new byte[] { 92, 131, 114, 131, 114, 39, 92, 210, 10, 160, 45, 18, 32, 101, 101, 133, 20, 20, 28, 45, 105, 204, 47, 137, 31, 186, 57, 132, 0, 127, 154, 137, 142, 250, 166, 15, 13, 232, 174, 170, 223, 166, 134, 46, 140, 9, 71, 129, 205, 18, 217, 197, 18, 227, 169, 223, 74, 65, 201, 16, 232, 180, 249, 206, 174, 140, 82, 30, 172, 183, 61, 50, 107, 23, 220, 41, 197, 18, 86, 141, 87, 252, 157, 120, 77, 94, 153, 103, 25, 173, 0, 231, 246, 13, 127, 89, 75, 73, 38, 207, 30, 4, 168, 122, 46, 3, 207, 58, 113, 201, 194, 251, 50, 237, 137, 126, 45, 37, 176, 210, 99, 61, 223, 208, 11, 164, 109, 245 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a606f482-66d6-4572-b8e2-0c83663cb854"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 17, 18, 18, 52, 33, DateTimeKind.Local).AddTicks(3367),
                            IsDeleted = false,
                            OperationClaimId = new Guid("2fa5d3f5-1770-45b6-af11-d8e251cc4f77"),
                            Status = 1,
                            UserId = new Guid("6d64ba23-da92-4364-93ae-7b129d56b771")
                        });
                });
