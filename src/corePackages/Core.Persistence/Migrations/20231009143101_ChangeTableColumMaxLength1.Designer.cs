...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20231009143101_ChangeTableColumMaxLength1")]
    partial class ChangeTableColumMaxLength1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61536409-8e85-4348-9699-8ed4c56f5f67"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 9, 17, 31, 0, 994, DateTimeKind.Local).AddTicks(9277),
                            IsDeleted = false,
                            Name = "Admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b30c9723-1de3-48e5-9f59-44d87d86284a"),
                            AuthenticatorType = 0,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 9, 17, 31, 0, 996, DateTimeKind.Local).AddTicks(4949),
                            CultureType = 0,
                            Email = "admin@admin.com",
                            FirstName = "Admin",
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 144, 207, 230, 125, 169, 78, 34, 52, 16, 71, 110, 187, 85, 37, 182, 96, 146, 104, 82, 94, 196, 179, 240, 184, 20, 194, 244, 57, 8, 53, 10, 87, 24, 233, 51, 40, 47, 172, 129, 109, 25, 169, 104, 29, 186, 114, 71, 73, 140, 246, 72, 159, 141, 245, 77, 138, 166, 78, 16, 236, 193, 105, 61, 187 },
                            PasswordSalt = new byte[] { 157, 147, 29, 150, 242, 170, 126, 168, 76, 122, 78, 31, 72, 233, 97, 62, 212, 119, 63, 1, 86, 70, 138, 221, 174, 200, 0, 116, 23, 224, 222, 43, 247, 118, 152, 208, 13, 112, 229, 57, 48, 19, 103, 89, 232, 29, 151, 145, 160, 227, 207, 25, 41, 17, 167, 127, 81, 183, 81, 128, 27, 127, 140, 59, 211, 156, 4, 43, 135, 231, 184, 95, 99, 249, 175, 72, 200, 203, 145, 181, 251, 113, 108, 101, 207, 164, 135, 192, 43, 217, 237, 35, 226, 177, 46, 66, 100, 24, 152, 114, 176, 8, 89, 253, 10, 162, 52, 170, 209, 101, 176, 26, 29, 158, 32, 145, 17, 219, 170, 144, 107, 158, 185, 185, 213, 221, 133, 44 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ce7ccc94-ad8f-469b-99e1-8bdef2109071"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 10, 9, 17, 31, 0, 997, DateTimeKind.Local).AddTicks(1856),
                            IsDeleted = false,
                            OperationClaimId = new Guid("61536409-8e85-4348-9699-8ed4c56f5f67"),
                            Status = 1,
                            UserId = new Guid("b30c9723-1de3-48e5-9f59-44d87d86284a")
                        });
                });
